...
## [5.0.0](https://github.com/frankudoags/revm/compare/revm-database-v4.0.1...revm-database-v5.0.0) - 2025-06-06

### Added

- *(database)* Implement DatabaseRef for State ([#2570](https://github.com/frankudoags/revm/pull/2570))
- added TxEnv::new_bench() add util function ([#2556](https://github.com/frankudoags/revm/pull/2556))
- transact multi tx ([#2517](https://github.com/frankudoags/revm/pull/2517))

### Other

- Avoid clone before converting ref BundleAccount to CacheAccount ([#2574](https://github.com/frankudoags/revm/pull/2574))
