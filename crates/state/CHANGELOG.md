...
## [5.0.0](https://github.com/frankudoags/revm/compare/revm-state-v4.0.1...revm-state-v5.0.0) - 2025-06-06
...
- *(multitx)* Add local flags for create and selfdestruct ([#2581](https://github.com/frankudoags/revm/pull/2581))

### Other

- unify calling of journal account loading ([#2561](https://github.com/frankudoags/revm/pull/2561))
